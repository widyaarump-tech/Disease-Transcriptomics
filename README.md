...
2. Weighted Gene Co-expression Network Analysis (WGCNA)
   Untuk mengidentifikasi modul gen yang berkorelasi dengan status penyakit dan genotipe APOE.
3. Functional Enrichment Analysis untuk menelaah jalur biologis yang dominan, khususnya:
   - respons imun
   - inflamasi
   - fungsi vaskular
...
4. Menyederhanakan hasil penelitian kompleks menjadi ringkasan sistematis
5. Menghubungkan perubahan ekspresi gen dengan mekanisme patogenesis penyakit
